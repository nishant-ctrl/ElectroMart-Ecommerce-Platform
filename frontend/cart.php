 ...
 <script>
  ...
  cartContainer.addEventListener("click", function (e) {
    if (e.target.classList.contains("increment-btn")) {
      e.preventDefault();
      const input = e.target.closest(".product_data").querySelector(".input-qty");
  ...
  cartContainer.addEventListener("click", function (e) {
    if (e.target.classList.contains("updateQty")) {
      ...
      let qty = input.value;
      const productId = button.closest(".product_data").querySelector(".product-id").value;
  ...
  cartContainer.addEventListener("click", function (e) {
    if (e.target.classList.contains("remove-btn")) {
      e.preventDefault();
      const button = e.target;
      const cartId = button.closest(".product_data").querySelector(".remove-btn").value;
