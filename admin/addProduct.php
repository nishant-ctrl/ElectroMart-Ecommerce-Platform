      ...
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div>
          <form action="code.php" method="post" enctype="multipart/form-data">
            <div>
              <label for="category" class="block text-3xl font-medium text-gray-700">Select Category</label>
            ...
            <div>
              <label for="popular" class="block text-3xl font-medium text-gray-700">Trending</label>
